...
#ifndef M_PI_2_F
#define M_PI_2_F        1.5707963267948966192313216916398f
#endif

#ifndef M_TWOPI_F
#define M_TWOPI_F       6.283185307179586476925286766559f
#endif
...
int map_projection_init(struct map_projection_reference_s *ref, double lat_0,
				 double lon_0, uint64_t time) //lat_0, lon_0 are expected to be in correct format: -> 47.1234567 and not 471234567
{
	return map_projection_init_timestamped(ref, lat_0, lon_0, time);
}
